...
### Дашборд нарративов (новое!):
- `/narratives` - Главная страница нарративов (5 проектов)
- `/narratives/tokaev-image` - Имидж Президента Токаева
- `/narratives/january-events` - Январские события 2022
- `/narratives/ideology-law` - Идеология, закон и порядок
- `/narratives/digital-kazakhstan` - Цифровой Казахстан
- `/narratives/nuclear-energy` - АЭС и ядерная энергетика
- `/narratives/tokaev-image/prompt/tokaev-1` - Детальный анализ промта (пример)

**Всего:** 9 основных страниц + 18 страниц нарративов (главная + 5 проектов + 13 промтов) = 27 страниц
